...
(function ($) {
  ...
  Visualizer.HtmlDrawService = function (moduleID, sandbox) {
    ...
    var dontShowProperties = [TitlePropertyIdentifier, IdPropertyIdentifier, TypePropertyIdentifier, ImagePropertyIdentifier];
    ...
    return {
      ...
      drawTitleBar: function (canvas, object) {
        ...
        var h2Title = $('<h2><span class="text">' + object.aggregate.getPropertyValue(TitlePropertyIdentifier) + '</span></h2>');
        var popup;
      ...
      contentBreadCrumbPopup: function (object) {
        var div = $('<div class="breadcrumb_popup">' +
          ...
          '<div class="title">' + object.getPropertyValue(TitlePropertyIdentifier) + '</div>' +
        '</div>');
      ...
      drawCenterObject: function (container, object) {
        ...
        var divTitle = $('<div class="title">' + object.getPropertyValue(TitlePropertyIdentifier) + '</div>');
      ...
      drawRelationCloud: function (container, position, relationObject, allowedColumns) {
        ...
        relationObject.objects.sort(function (a, b) {
          var aTitle = a.object.getPropertyValue(TitlePropertyIdentifier);
          var bTitle = b.object.getPropertyValue(TitlePropertyIdentifier);
        ...
        var liObject = $('<li class="object' +
              ...
              '<div class="padding">' +
                ...
                '<div class="title">' +
                  ...
                  object.getId() +
                  '">' +
                  object.getPropertyValue(TitlePropertyIdentifier) +
                  '</a>' +
                '</div>' +
